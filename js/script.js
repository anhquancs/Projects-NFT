...
// Start or stop the auto change background color
document.getElementById('auto-change-background').addEventListener('click', function() {
    if (!autoChangeEnabled) {
        autoChangeEnabled = true;
        this.textContent = 'Stop Auto Change Background';

        // Start interval to change background color every second
        ...
        this.textContent = 'Auto Change Background';
